...
const foodBlockUnit = canvasSize / snackSize;
...
export const SnackGame = {
	...
	createSnack: () =>{
		...
		snackBody.forEach(body =>{
			ctx.fillRect(body.snackX,body.snackY, snackSize-1, snackSizeY-1);
		})
		SnackGame.createFood();
	},
